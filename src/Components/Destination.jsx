    ...
    return (
        ...
        <div>
            ...
            <div className='max-[1240px] my-20 mx-10 m-auto md:grid md:grid-cols-3'>
                ...
                <div className='md:w-[400px] w-[300px] mx-5 rounded-lg  bg-[#c3caca]'>
                    ...
                    <p className='text-center mx-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        ...
                        <button className='bg-yellow-300 p-[10px] ml-[50px] md:ml-[100px] my-5 rounded-full w-[200px]'>Destinations</button>
                </div> 
                <div className='md:w-[400px] w-[300px] rounded-lg mx-5 md:my-1 my-20  bg-[#c3caca]'>
