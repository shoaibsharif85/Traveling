...
<div className=' my-20 mx-20'>
    <h1 className='md:text-5xl text-2xl font-bold text-white md:ml-[50px]  md:mt-[100px]'>At TripPixie, we are ready
    ...
    <button className='bg-yellow-300 p-[10px] ml-[10px] md:ml-[150px] my-5 rounded-full w-[200px]'>Destinations</button>
    </div>
